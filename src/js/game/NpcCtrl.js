        ...
        tasks: [{
            ...
            messages: [
                [
                    ...
                    '然而，一个拥有着邪恶力量的恶魔铲屎官闯进了喵喵村，并抓走了喵神melonpi。',
                    '在村民们的奋起反击下，恶魔铲屎官不堪地逃走了。',
                    '但是喵神melonpi却落到了随同恶魔铲屎官的疯犬的手里。',
                    '喵神melonpi和疯犬就在喵喵村的某一处地方，请你击退各种各样的怪物并将喵神melonpi带回喵喵村。'
                ],
                [
