lynx.PlayerCtrl = function(camera, player, domElement) {
    ...
    this.update = function(delta) {
        ...
        cameraPos.y = playerPos.y + 1;// + this.player.userData.height / 2;
        cameraPos.x = playerPos.x + cosXAxesCamera * 5;//this.player.userData.width / 2;
        cameraPos.z = playerPos.z + cosZAxesCamera * 5;//this.player.userData.width / 2;
